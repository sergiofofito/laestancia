    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden mt-20 no-global-bg">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-6xl mx-auto">
        ...
        <div className="mb-12 animate-fade-in-up stagger-2">
          ...
          <p className="font-playfair text-xl md:text-2xl font-light tracking-wide opacity-90">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in-up stagger-3">
          <a
            href="/food"
            className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-inter text-lg min-w-[200px] px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group"
          >
          ...
          <a
            ...
            className="btn-secondary font-inter text-lg min-w-[200px] relative overflow-hidden group"
          >
