      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {reviews.map((review, index) => (
            <div
              key={index}
              className={`bg-card rounded-2xl p-8 shadow-warm hover:shadow-gold transition-all duration-300 hover:-translate-y-2 border border-border animate-fade-in-up stagger-${index + 1}`}
            >
              {/* Rating Stars */}
              ...
              {/* Review Text */}
              <blockquote className="font-inter text-foreground/80 leading-relaxed mb-6 italic text-center">
                "{review.review}"
              </blockquote>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <div>
                  ...
                  <div className="font-inter text-sm text-foreground/60">{review.date}</div>
                </div>
        ...
        {/* Overall Rating */}
        <div className="bg-gradient-to-r from-secondary/20 to-accent/20 rounded-2xl p-8 lg:p-12 border border-secondary/30">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="font-inter text-foreground/70">Based on 150+ reviews</div>
            </div>
            ...
            <div className="space-y-3">
              {[5, 4, 3, 2, 1].map((stars) => (
                <div key={stars} className="flex items-center space-x-3">
                  <span className="font-inter text-sm text-foreground/70 w-8">{stars}★</span>
                  ...
                  <span className="font-inter text-sm text-foreground/70 w-8">
